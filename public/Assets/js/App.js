    ...
    async function setConnection(connId){
        ...
        connection.ontrack = function(event){
            ...
            else if(event.track.kind == "audio")
            {
                ...
                remoteaudioplayer.load();updateMediaSenders(videoCamTrack, rtp_vid_senders);
            }
        }
...
var Myapp = (function() {
    ...
    function event_process_for_signaling_server(){
        ...
        socket.on("showFileMessage", function(data){
            ...
            attachfileareaforother.innerHTML += "<div class='left-align' style='display:flex; align-items:center;'><img src='public/assets/images/other.png' style='height:40px; width:40px;' class='caller-image circle'><div style='font-weight:600; margin:0 5px;'>"+data.username+"</div>:<div><a style='color: #007bff;' href='"+data.filePath+"' download>"+data.fileName+"</a></div></div><br />";
    ...
    function eventHandling(){
        $("#btnSend").on("click", function(){
            ...
            var div = $("<div>").html("<span class='font-weight-bold mr-3' style='color:black'>" + user_id+ "</span>" + lTime + "</br>" + msgbox);
            $("#messages").append(div);
            $("#msgbox").val("");
        });
    ...
    $(document).on("click", ".share-attach", function(e) {
        ...
        attachfilearea.innerHTML += "<div class='left-align' style='display:flex; align-items:center;'><img src='public/assets/images/other.png' style='height:40px; width:40px;' class='caller-image circle'><div style='font-weight:600; margin:0 5px;'>"+user_id+"</div>:<div><a style='color: #007bff;' href='"+attachfilepath+"' download>"+attachfilename+"</a></div></div><br />";
